...
class ProfessionalsTest < ApplicationSystemTestCase
  ...
  test "should create professional" do
    ...
    fill_in "Class eng", with: @professional.class_eng
    fill_in "Description", with: @professional.description
    fill_in "Industry", with: @professional.industry
    fill_in "Name", with: @professional.name
    fill_in "Proj avail", with: @professional.proj_avail
    fill_in "Student exp", with: @professional.student_exp
    fill_in "Teacher mentor", with: @professional.teacher_mentor
