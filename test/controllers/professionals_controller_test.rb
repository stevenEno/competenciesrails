...
class ProfessionalsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create professional" do
    assert_difference("Professional.count") do
      post professionals_url, params: { professional: { class_eng: @professional.class_eng, description: @professional.description, industry: @professional.industry, name: @professional.name, proj_avail: @professional.proj_avail, student_exp: @professional.student_exp, teacher_mentor: @professional.teacher_mentor } }
    end
  ...
  test "should update professional" do
    patch professional_url(@professional), params: { professional: { class_eng: @professional.class_eng, description: @professional.description, industry: @professional.industry, name: @professional.name, proj_avail: @professional.proj_avail, student_exp: @professional.student_exp, teacher_mentor: @professional.teacher_mentor } }
